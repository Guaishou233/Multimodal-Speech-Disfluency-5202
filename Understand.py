...
# from audio_helper_functions import _resample_if_necessary, _cut_if_necessary, _right_pad_if_necessary, \
...
#                     default='EfficientMM:: Audio-Video unified Fusion Model with missing video in inference', type=str,
#                     metavar='N',
#                     )
# parser.add_argument('--chkpt_pth', default='/home/payal/multimodal_speech/main_codebase/saved_models/audio_video_only/',
#                     type=str,
#                     metavar='N',
...
#
# ##################################################################################################
# # Read the train-test split file and get samples
# ##################################################################################################
...
# train_dataset, valid_dataset = train_test_split(train_dataset_main, test_size=0.3, random_state=123, shuffle=True,
#                                                 stratify=y_train)
#
...
#                                                          num_layers=2)  ## num_layers is same as N in the transformer figure in the transformer paper
...
# model = AVStutterNet_student().to(device)
...
#             print('End of Epoch', epoch, 'Overall loss is', '%.4f' % np.mean(overall_loss_list),
#                   '    Training accuracy is ', '%.4f' % np.mean(class_acc_list))
#
...
#
#     # train for one epoch
#     overall_loss_list, class_loss_list, class_acc_train = train_one_epoch(train_dataloader, model, class_loss_criterion,
#                                                                           optimizer, epoch)
#
...
#     class_loss_valid, class_acc_valid, _ = evaluate_one_epoch(valid_dataloader, model, class_loss_criterion, optimizer,
#                                                               epoch)
...
#
#     ## Evaluate every epoch for in-domain data in validation # FIXME :: Currently the valid and test sets are the same.
#     class_loss_test, class_acc_test, f1_score_test = evaluate_one_epoch(test_dataloader, model, class_loss_criterion,
#                                                                         optimizer, epoch)
...
# #     parser = argparse.ArgumentParser(description='EfficientMM')
# #     parser.add_argument('--log_comment',
# #                         default='EfficientMM Audio-Video unified Fusion Model with missing video in inference',
# #                         type=str,
# #                         metavar='N',
# #                         )
...
# #                         metavar='evalutaion on FLOP and FPS',
# #                         )
# #
# #     args = parser.parse_args()
# #
...
# #     wandb.login()
# #
# #     if os.path.exists(model_chkpt_pth):
# #         checkpoint = torch.load(model_chkpt_pth)
...
# #
# #         # train for one epoch
# #         overall_loss_list, class_loss_list, class_acc_train = train_one_epoch(train_dataloader, model,
# #                                                                               class_loss_criterion, optimizer, epoch)
# #
...
# #         }
# #         filename = 'baseline_{:04d}.pth'.format(epoch)
# #
# #         torch.save(checkpoint,model_chkpt_pth+filename)
# #         # average loss through all iterations --> Avg loss of an epoch
# #         overall_loss_epoch = sum(overall_loss_list) / len(overall_loss_list)
# #         class_loss_epoch = sum(class_loss_list) / len(class_loss_list)
# #         class_acc_epoch = sum(class_acc_train) / len(class_acc_train)
...
# #
# #         ## Evaluate every epoch for in-domain data in validation # FIXME :: Currently the valid and test sets are the same.
# #         class_loss_valid, class_acc_valid, _ = evaluate_one_epoch(valid_dataloader, model, class_loss_criterion,
# #                                                                   optimizer, epoch)
